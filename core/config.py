...
SOURCE_FIELD_SYNONYMS: dict[str, dict[str, list[str]]] = {
    "volunteers": {
        ...
        "birthday": ["birthday", "birthdate", "birth date", "dob", "date of birth"],
        "match_date": ["match activation date", "activation date", "match date",
                        "matched", "match start", "start date", "activation"],
